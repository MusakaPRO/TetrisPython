...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    surface.blit(label, (start_x + 20, start_y + play_height / 2 - 50))
    ...
    image_rect.bottomright = (s_width - 10, s_height - 10)
...
def main():
    ...
    while run:
        ...
        draw_window(win, grid, score, get_max_score())
        draw_next_shape(next_piece, win)
        pygame.display.update()

        if check_lost(locked_positions):
            draw_text_middle('YOU LOST!', 70, (255, 255, 255), win)
            pygame.display.update()
...
pygame.display.set_caption('Tetris VTS')
main_menu()
